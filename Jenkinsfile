...
'''
  ...
  parameters {
    ...
    string(name: 'INFRA_VALUES_PATH', defaultValue: 'environments/dev/apps/frontend-values.yaml', description: '업데이트할 values 파일 경로')
  }
  ...
  environment {
    ...
    DEFAULT_INFRA_VALUES_PATH = 'environments/dev/apps/frontend-values.yaml'
  }
